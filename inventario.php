      ...
      <div class="main-panel">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Inventario</h3>
                </div>
        ...
        <div class="card">
          <div class="card__image-container">
            <img
              src="assets/images/respuestos/aceite.jpg"
            />
          </div>
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/bateria.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/amortiguadores.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/correas.jpeg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/neumaticos.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/motor.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/filtro_aceite.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
        ...
        <div class="card">
          <div class="card__image-container">
            <img
            src="assets/images/respuestos/focos.jpg"
            />
          </div>
          <div class="card__content">
            <p class="card__title text--medium">
