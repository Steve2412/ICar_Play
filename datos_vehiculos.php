                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="table-responsive">
                        <div id="table_vehiculos" class="table table-striped table-borderless"></div>
             </div>
             </div>
                    </div>
                  </div>
...
$(document).ready(function(){
   ...
   load_list();
         ...
         {
            var action = "datos_vehiculos";
            var modelo = <?php echo json_encode("$id", JSON_HEX_TAG); ?>;
            console.log(modelo);
            $.ajax({
               url:"action.php",
               type:"POST",
               data:{action:action,page:page,modelo:modelo},
               success:function(data)
               {
                     $('#table_vehiculos').html(data);
               }
            });
         }
