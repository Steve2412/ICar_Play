      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Editar mecanico</h3>
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            ...
            <label for="estado_trabajo" style="font-size:20px">Estado</label>
               ...
               <option style="font-size:20px" value="activo">activo</option>
               <option style="font-size:20px" value="inactivo">inactivo</option>
               </select>

               <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <button type="button" name="actualizar_mecanico" id="actualizar_mecanico" class="btn btn-success">Actualizar Mecanico</button><br><br>
                </div>
...
$(document).ready(function(){
        ...
        $(document).on('click','#actualizar_mecanico',function(){
            var estado_trabajo= $('#estado_trabajo').val();
            var id = <?php echo json_encode("$id", JSON_HEX_TAG); ?>;

            var action = "actualizar_mecanico";


            if(estado_trabajo != '' || id != ''){
                $.ajax(
                    {
                    url:"action.php",
                    type:"POST",
                    data:{action:action,estado_trabajo:estado_trabajo,id:id},
                    success:function(data)
                    {
                        alert(data);
                        window.location = "mecanicos.php";
                    }
                    }
                )
