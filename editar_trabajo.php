      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <textarea name="" id="desc_trabajo" cols="200" rows="10"><?php echo $descripcion ?></textarea>
            ...
            <label for="estado_trabajo" style="font-size:20px">Estado</label>
               ...
               <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <button type="button" name="actualizar_trabajo" id="actualizar_trabajo" class="btn btn-success">Actualizar Trabajo</button><br><br>
                </div>
...
$(document).ready(function(){
        ...
        $(document).on('click','#actualizar_trabajo',function(){
            ...
            if(desc_trabajo != ''){
                $.ajax(
                    ...
                    url:"action.php",
                    type:"POST",
                    data:{action:action,desc_trabajo:desc_trabajo,estado_trabajo:estado_trabajo,id:id},
